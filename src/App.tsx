          ...
          <Card className="max-w-3xl">
            <div className="flex flex-col sm:flex-row items-center gap-6 md:gap-8">
              ...
              <div className="flex-1 text-center sm:text-left">
                ...
                <p className="text-gray-700 dark:text-gray-300 text-md md:text-lg mb-4">Full Stack Developer passionate about creating beautiful and functional web applications. With 5 years of experience in modern web technologies.</p>
